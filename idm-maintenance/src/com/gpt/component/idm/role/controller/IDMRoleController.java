package com.gpt.component.idm.role.controller;
...
@RestController
public class IDMRoleController extends BankBaseController {
	
	protected static final String menuCode = "MNU_GPCASH_IDM_ROLE";
	...
	public DeferredResult<Map<String, Object>> genericHandler(HttpServletRequest request, @PathVariable String method, @RequestBody Map<String, Object> param) {
		return invoke("IDMRoleSC", method, param);
	}
}