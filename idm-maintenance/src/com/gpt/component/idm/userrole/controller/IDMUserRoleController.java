package com.gpt.component.idm.userrole.controller;
...
@RestController
public class IDMUserRoleController extends BankBaseController {
	
	protected static final String menuCode = "MNU_GPCASH_IDM_USER_ROLE";
	...
	public DeferredResult<Map<String, Object>> genericHandler(@PathVariable String method, @RequestBody Map<String, Object> param) {
		return invoke("IDMUserRoleSC", method, param);
	}
}