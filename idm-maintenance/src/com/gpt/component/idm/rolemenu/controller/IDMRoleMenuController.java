package com.gpt.component.idm.rolemenu.controller;
...
@RestController
public class IDMRoleMenuController extends BankBaseController {
	
	protected static final String menuCode = "MNU_GPCASH_IDM_ROLE_MENU";
	...
	public DeferredResult<Map<String, Object>> genericHandler(@PathVariable String method, @RequestBody Map<String, Object> param) {
		return invoke("IDMRoleMenuSC", method, param);
	}
}
