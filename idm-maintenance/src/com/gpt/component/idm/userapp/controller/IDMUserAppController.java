package com.gpt.component.idm.userapp.controller;
...
@RestController
public class IDMUserAppController extends BankBaseController {

	protected static final String menuCode = "MNU_GPCASH_IDM_USER_APP";
	...
	public DeferredResult<Map<String, Object>> genericHandler(@PathVariable String method, @RequestBody Map<String, Object> param) {
		return invoke("IDMUserAppSC", method, param);
	}
}
