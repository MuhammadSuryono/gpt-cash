...
@Service
public class MultiPendingTaskServiceImpl implements MultiPendingTaskService {
	private static final Logger logger = LoggerFactory.getLogger(MultiPendingTaskServiceImpl.class);
	...
	public Map<String, Object> approveList(Map<String, Object> map) throws ApplicationException, BusinessException {
		...
		for(Map<String, Object> pendingTaskMap: pendingTaskList){
			...
			inputMap.put(ApplicationConstants.LOGIN_USERID, loginId);
