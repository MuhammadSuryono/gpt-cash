package com.gpt.component.pendingtask.model;
...
@Entity
@Table(name = "WF_PENDING_TASK", indexes = {
	@Index(name="WF_PENDING_UNIQUE1", unique = true, columnList = "REFERENCE_NO"),
	@Index(name="WF_PENDING_INDEX1", unique = false, columnList = "STATUS")	
})
public class PendingTaskModel implements Serializable {
	...
	@ElementCollection(fetch = FetchType.LAZY)
	@CollectionTable(
		name = "WF_PENDING_TASK_OLD_VALUE", 
		joinColumns = @JoinColumn(name="PARENT_ID")
    )
	@OrderColumn(name = "IDX")
	@Column(name = "VALUES_", length = 1024)
	...
	public void setOldValuesStr(String oldValues) throws Exception {
