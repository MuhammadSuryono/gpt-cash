...
@AutoDiscoveryImpl
public interface ActivityLogSC {
	
	String menuCode = "MNU_GPCASH_LOG_ACTV";
	
	void saveActivityLog(String menuCode, String menuName, String action, String loginId, boolean isError, String errorCode, String errorDescription, String errorTrace, String referenceNo, Timestamp activityDate, String logId);
