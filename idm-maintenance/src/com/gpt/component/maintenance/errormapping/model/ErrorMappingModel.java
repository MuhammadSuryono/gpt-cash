package com.gpt.component.maintenance.errormapping.model;
...
@Entity
@Table(name = "MT_ERROR_MAPPING")
public class ErrorMappingModel implements Serializable {
