package com.gpt.component.maintenance.denomprepaid.controller;
...
@RestController
public class PrepaidDenominationController extends BankBaseController {
	protected static final String menuCode = "MNU_GPCASH_MT_PREPAID_DENOM";
	...
	public DeferredResult<Map<String, Object>> genericHandler(HttpServletRequest request, @PathVariable String method, @RequestBody Map<String, Object> param) {
		return invoke("PrepaidDenominationSC", method, param);
	}
}
