package com.gpt.component.maintenance.parametermt.controller;
...
@RestController
public class ParameterMaintenanceController extends BankBaseController {
		
	protected static final String menuCode = "MNU_GPCASH_MT_PARAMETER";
	...
	public DeferredResult<Map<String, Object>> genericHandler(@PathVariable String method, @RequestBody Map<String, Object> param, HttpServletRequest req, HttpServletResponse res) {
		return invoke("ParameterMaintenanceSC", method, param);
	}
