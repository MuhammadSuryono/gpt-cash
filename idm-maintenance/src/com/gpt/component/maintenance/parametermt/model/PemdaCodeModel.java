...
@Entity
@Cacheable
@Table(name = "MT_PEMDA_CODE")
public class PemdaCodeModel implements Serializable {
	/**
	...
	@Column(name="BPHTB_ID")
	public String bphtbId;
	...
	public String getBphtbId() {
		return bphtbId;
	}

	public void setBphtbId(String bphtbId) {
		this.bphtbId = bphtbId;
	}
