package com.gpt.component.maintenance.interestrate.controller;
...
@RestController
public class InterestRateController extends BankBaseController {
	
	protected static final String menuCode = "MNU_GPCASH_MT_INTEREST_RATE";
	...
	public DeferredResult<Map<String, Object>> genericHandler(@PathVariable String method, @RequestBody Map<String, Object> param, HttpServletRequest req, HttpServletResponse res) {
		return invoke("InterestRateSC", method, param);
	}
