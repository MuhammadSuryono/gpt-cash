...
@AutoDiscoveryImpl
public interface BranchSC extends WorkflowService {
	
	String menuCode = "MNU_GPCASH_MT_BRANCH";
	...
	Map<String, Object> searchLevelForDroplist(Map<String, Object> map) throws ApplicationException, BusinessException;
}
