package com.gpt.component.maintenance.branch.controller;
...
@RestController
public class BranchController extends BankBaseController {
	
	protected static final String menuCode = "MNU_GPCASH_MT_BRANCH";
	...
	public DeferredResult<Map<String, Object>> genericHandler(@PathVariable String method, @RequestBody Map<String, Object> param, HttpServletRequest req, HttpServletResponse res) {
		return invoke("BranchSC", method, param);
	}
