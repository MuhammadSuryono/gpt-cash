package com.gpt.product.gpcash.limitupdate.controller;
...
@RestController
public class LimitUpdateController extends BankBaseController {
	
	protected static final String menuCode = "MNU_GPCASH_PRO_LMT_UPDATE";
	...
	public DeferredResult<Map<String, Object>> genericHandler(@PathVariable String method, @RequestBody Map<String, Object> param) {
		...
		return invoke("LimitUpdateSC", method, param);
	}
}