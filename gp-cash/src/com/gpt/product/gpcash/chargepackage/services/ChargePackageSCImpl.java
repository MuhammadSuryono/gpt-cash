...
public class ChargePackageSCImpl implements ChargePackageSC{
	...
	@Input({
		...
		@Variable(name = "transactionChargeList", type = List.class, subVariables = {
	...
	public Map<String, Object> submit(Map<String, Object> map) throws ApplicationException, BusinessException {
		...
		return chargePackageService.submit(map);
	}

	@EnableActivityLog
	@Override
	public PendingTaskVO approve(PendingTaskVO vo) throws ApplicationException, BusinessException {
		return chargePackageService.approve(vo);
	}

	@EnableActivityLog
	@Override
	public PendingTaskVO reject(PendingTaskVO vo) throws ApplicationException, BusinessException {
		return chargePackageService.reject(vo);
	}
