package com.gpt.product.gpcash.chargepackage.controller;
...
@RestController
public class ChargePackageController extends BankBaseController {
	
	protected static final String menuCode = "MNU_GPCASH_PRO_CH_PC";
	...
	public DeferredResult<Map<String, Object>> genericHandler(@PathVariable String method, @RequestBody Map<String, Object> param) {
		...
		return invoke("ChargePackageSC", method, param);
	}
}
