...
public abstract class BaseApproverStage extends Stage {
	
	protected abstract void createAndAssignTasksToUsers(ProcessInstance pi, int noOfUser, int currApprLv, List<Object> approvalData) throws BusinessException, ApplicationException;
	...
	protected boolean isSkipToNextStage(ProcessInstance pi) {
		return false;
	}
