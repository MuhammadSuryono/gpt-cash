package com.gpt.product.gpcash.limitpackage.controller;
...
@RestController
public class LimitPackageController extends BankBaseController {
	
	protected static final String menuCode = "MNU_GPCASH_PRO_LMT_PC";
	...
	public DeferredResult<Map<String, Object>> genericHandler(@PathVariable String method, @RequestBody Map<String, Object> param) {
		...
		return invoke("LimitPackageSC", method, param);
	}
}
