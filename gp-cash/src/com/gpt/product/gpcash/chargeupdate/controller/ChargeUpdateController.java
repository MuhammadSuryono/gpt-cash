package com.gpt.product.gpcash.chargeupdate.controller;
...
@RestController
public class ChargeUpdateController extends BankBaseController {
	
	protected static final String menuCode = "MNU_GPCASH_PRO_CH_UPDATE";
	...
	public DeferredResult<Map<String, Object>> genericHandler(@PathVariable String method, @RequestBody Map<String, Object> param) {
		...
		return invoke("ChargeUpdateSC", method, param);
	}
}