package com.gpt.product.gpcash.servicepackage.controller;
...
@RestController
public class ServicePackageController extends BankBaseController {
	
	protected static final String menuCode = "MNU_GPCASH_PRO_SRVC_PC";
	...
	public DeferredResult<Map<String, Object>> genericHandler(@PathVariable String method, @RequestBody Map<String, Object> param) {
		...
		return invoke("ServicePackageSC", method, param);
	}
}
