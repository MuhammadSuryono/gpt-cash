...
@Validate
@Service
public class CustomerChangePasswordSCImpl implements CustomerChangePasswordSC {
	...
	public Map<String, Object> userChangePassword(Map<String, Object> map) throws ApplicationException, BusinessException {
		...
		idmUserService.changePassword((String) map.get(ApplicationConstants.CUST_ID), (String) map.get("oldPassword"), (String) map.get("newPassword"),
	...
	public Map<String, Object> changePassword(Map<String, Object> map) throws ApplicationException, BusinessException {
		idmUserService.changePassword2((String) map.get(ApplicationConstants.CUST_ID), (String) map.get("key"), (String) map.get("newPassword"),
				(String) map.get("newPassword2"));
