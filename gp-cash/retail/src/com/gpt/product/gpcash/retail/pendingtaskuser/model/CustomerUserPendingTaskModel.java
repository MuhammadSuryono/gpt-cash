package com.gpt.product.gpcash.retail.pendingtaskuser.model;
...
@Entity
@Table(name = "CUSTUSR_WF_PENDING", indexes = {
	@Index(name="CUSTUSR_WF_PENDING_UNIQUE1", unique = true, columnList = "REFERENCE_NO"),
	@Index(name="CUSTUSR_WF_PENDING_INDEX1", unique = false, columnList = "STATUS")	
})
public class CustomerUserPendingTaskModel implements Serializable {
	...
	@Column(name = "SOURCE_ACCT_NO_DTL_ID")
	...
	@ElementCollection(fetch = FetchType.LAZY)
	@CollectionTable(
		name = "CUSTUSR_WF_PENDING_OLD_VALUE",
		joinColumns = @JoinColumn(name="PARENT_ID")
    )
	@OrderColumn(name = "IDX")
	@Column(name = "VALUES_", length = 1024)
	...
	protected CustomerTransactionStatus trxStatus;
	...
	public CustomerTransactionStatus getTrxStatus() {
		return trxStatus;
	}
	
	public void setTrxStatus(CustomerTransactionStatus trxStatus) {
