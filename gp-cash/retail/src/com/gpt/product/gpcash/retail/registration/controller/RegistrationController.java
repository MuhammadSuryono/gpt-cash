package com.gpt.product.gpcash.retail.registration.controller;
...
@RestController
public class RegistrationController extends CustomerUserBaseController {
	
	@RequestMapping(baseCustUserUrl + "/{method}")
	public DeferredResult<Map<String, Object>> genericHandler(HttpServletRequest request, @PathVariable String method, @RequestBody Map<String, Object> param) {
		return invoke("RegistrationSC", method, param);
	}
}