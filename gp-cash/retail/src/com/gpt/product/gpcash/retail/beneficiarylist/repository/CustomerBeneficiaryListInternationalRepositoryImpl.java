...
public class CustomerBeneficiaryListInternationalRepositoryImpl extends CashRepositoryImpl<CustomerBeneficiaryListInternationalModel> {
	...
	public Page<CustomerBeneficiaryListInternationalModel> search(Map<String, Object> paramMap, Pageable pageInfo) throws Exception {
		CriteriaBuilder builder = em.getCriteriaBuilder();
		CriteriaQuery<CustomerBeneficiaryListInternationalModel> query = builder.createQuery(clazz);
		
		Root<CustomerBeneficiaryListInternationalModel> root = query.from(clazz);
