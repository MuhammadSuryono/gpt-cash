package com.gpt.product.gpcash.retail.customerlimit.controller;
...
@RestController
public class CustomerLimitController extends BankBaseController {
	
	protected static final String menuCode = "MNU_R_GPCASH_CUST_LMT_PC_DTL";
	...
	public DeferredResult<Map<String, Object>> genericHandler(@PathVariable String method, @RequestBody Map<String, Object> param) {
		...
		return invoke("CustomerLimitSC", method, param);
	}
}
