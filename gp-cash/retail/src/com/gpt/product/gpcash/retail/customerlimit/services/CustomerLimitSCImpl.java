...
@Validate
@Service
public class CustomerLimitSCImpl implements CustomerLimitSC {
	...
	public Map<String, Object> search(Map<String, Object> map) throws ApplicationException, BusinessException {
		...
		return customerLimitService.search(map);
	}
	...
	@Input({
		...
		@Variable(name = "customerLimitList", type = List.class, subVariables = {
			@SubVariable(name = "id"),
	...
	public Map<String, Object> submit(Map<String, Object> map) throws ApplicationException, BusinessException {
		return customerLimitService.submit(map);
	}

	@EnableActivityLog
	@Override
	public PendingTaskVO approve(PendingTaskVO vo) throws ApplicationException, BusinessException {
		return customerLimitService.approve(vo);
	}

	@EnableActivityLog
	@Override
	public PendingTaskVO reject(PendingTaskVO vo) throws ApplicationException, BusinessException {
		return customerLimitService.reject(vo);
	}
	...
	public void resetLimit(String parameter) throws ApplicationException, BusinessException {
		customerLimitService.resetLimit(parameter);
	}
}
