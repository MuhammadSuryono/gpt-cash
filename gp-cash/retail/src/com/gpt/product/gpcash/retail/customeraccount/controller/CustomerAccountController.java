package com.gpt.product.gpcash.retail.customeraccount.controller;
...
@RestController
public class CustomerAccountController extends BankBaseController {
	
	protected static final String menuCode = "MNU_R_GPCASH_CUST_ACCT";
	...
	public DeferredResult<Map<String, Object>> genericHandler(HttpServletRequest request, @PathVariable String method, @RequestBody Map<String, Object> param) {
		return invoke("CustomerAccountSC", method, param);
	}
}
