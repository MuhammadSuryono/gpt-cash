package com.gpt.product.gpcash.biller.institution.controller;
...
@RestController
public class InstitutionController extends BankBaseController {
	
	protected static final String menuCode = "MNU_GPCASH_MT_INSTITUTION";
	...
	public DeferredResult<Map<String, Object>> genericHandler(HttpServletRequest request, @PathVariable String method, @RequestBody Map<String, Object> param) {
		return invoke("InstitutionSC", method, param);
	}
}