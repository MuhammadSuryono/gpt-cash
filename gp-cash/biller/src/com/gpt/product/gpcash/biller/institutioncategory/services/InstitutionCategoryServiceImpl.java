...
import com.gpt.product.gpcash.biller.institutioncategory.repository.InstitutionCategoryRepository;
...
public class InstitutionCategoryServiceImpl implements InstitutionCategoryService {
	...
	@Autowired
	private InstitutionCategoryRepository institutionCategoryRepo;
	
	@Override
	public Map<String, Object> search(Map<String, Object> map) throws ApplicationException, BusinessException {
		Map<String, Object> resultMap = new HashMap<>();
		try {
			Page<InstitutionCategoryModel> result = institutionCategoryRepo.search(map, PagingUtils.createPageRequest(map));
	...
	private List<Map<String, Object>> setModelToMap(List<InstitutionCategoryModel> list, boolean isGetDetail) {
		List<Map<String, Object>> resultList = new ArrayList<>();

		for (InstitutionCategoryModel model : list) {
	...
	private Map<String, Object> setModelToMap(InstitutionCategoryModel model, boolean isGetDetail) {
