...
@Validate
@Service
public class ChequeOrderSCImpl implements ChequeOrderSC {
	...
	@Input({
		...
		@Variable(name = ApplicationConstants.TRANS_SERVICE_CODE, options = { ChequeConstants.SRVC_GPT_CHQ_ORDER}),
		@Variable(name = "noOfPages", type = Integer.class),
...
//				ApplicationConstants.SI_IMMEDIATE, //unremark if in the future can immediate
				ApplicationConstants.SI_FUTURE_DATE, 
//				ApplicationConstants.SI_RECURRING //unremark if in the future can recurring
		}), 
	...
	public Map<String, Object> submit(Map<String, Object> map) throws ApplicationException, BusinessException {
		...
		Map<String, Object> resultMap = chequeOrderService.submit(map);
...
//			ApplicationConstants.SI_RECURRING //unremark if in the future can recurring
	...
	public Map<String, Object> confirm(Map<String, Object> map) throws ApplicationException, BusinessException {
		...
		map = chequeOrderService.confirm(map);
	...
	public CorporateUserPendingTaskVO approve(CorporateUserPendingTaskVO vo) throws ApplicationException, BusinessException {
		...
		vo = chequeOrderService.approve(vo);
	...
	public CorporateUserPendingTaskVO reject(CorporateUserPendingTaskVO vo) throws ApplicationException, BusinessException {
		return chequeOrderService.reject(vo);
	}
	...
	public Map<String, Object> detailExecutedTransaction(Map<String, Object> map) throws ApplicationException, BusinessException {
		return chequeOrderService.detailExecutedTransaction(map);
	}
	...
	public Map<String, Object> cancelTransaction(Map<String, Object> map) throws ApplicationException, BusinessException {
		chequeOrderService.cancelTransaction(map);
	...
	public Map<String, Object> downloadTransactionStatus(Map<String, Object> map) throws ApplicationException, BusinessException {
		return chequeOrderService.downloadTransactionStatus(map);
	}
	...
	@Validate
	@Input({
		@Variable(name = "cityCode", required = false, format = Format.UPPER_CASE),
		@Variable(name = ApplicationConstants.LOGIN_USERID, format = Format.UPPER_CASE), 
		@Variable(name = ApplicationConstants.WF_ACTION, options = ApplicationConstants.WF_ACTION_SEARCH), 
		@Variable(name = ApplicationConstants.STR_MENUCODE, options = menuCode) 
	})
	...
	@Override
	public Map<String, Object> searchChequePagesForDroplist(Map<String, Object> map) throws ApplicationException, BusinessException {
		map.put("modelCode", "COM_MT_CHEQUE_PAGES"); 
		return parameterMaintenanceService.searchModel(map);
	}
}