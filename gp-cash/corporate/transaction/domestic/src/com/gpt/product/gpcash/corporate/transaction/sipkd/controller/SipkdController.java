package com.gpt.product.gpcash.corporate.transaction.sipkd.controller;
...
@RestController
public class SipkdController extends CorporateUserBaseController{

	protected static final String menuCode = "MNU_GPCASH_F_SIPKD";
	private static final String SIPKDService = "SipkdSC";
	...
	public DeferredResult<Map<String, Object>> genericHandler(HttpServletRequest request, @PathVariable String method, @RequestBody Map<String, Object> param) {
		...
		return invoke(SIPKDService, method, param);
	}
	...
	public DeferredResult<Map<String, Object>> confirm(HttpServletRequest request,
		...
		return invoke(SIPKDService, "confirm", (DeferredResult<Map<String, Object>> deferredResult, Map<String, Object> map) -> {
	...
	public DeferredResult<Map<String, Object>> approve(HttpServletRequest request,
		...
		return invoke(SIPKDService, "submit", param);
	}
	...
	public DeferredResult<Map<String, Object>> downloadPeriodicTransaction(HttpServletRequest request, HttpServletResponse response, @RequestBody Map<String, Object> param) {
		return invoke(SIPKDService, "downloadTransactionStatus", 
