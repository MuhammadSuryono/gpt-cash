...
@Validate
@Service
public class DomesticTransferSCImpl implements DomesticTransferSC {
	...
	public Map<String, Object> submit(Map<String, Object> map) throws ApplicationException, BusinessException {
		...
		/*transactionValidationService.validateChargeAndTotalTransaction((String) map.get(ApplicationConstants.LOGIN_CORP_ID), 
				...
				(String)map.get(ApplicationConstants.APP_CODE), (ArrayList<Map<String,Object>>) map.get("chargeList"), (String) map.get("chargeInstruction"));*/
	...
	public Map<String, Object> confirm(Map<String, Object> map) throws ApplicationException, BusinessException {
		...
		Map limitMap = transactionValidationService.validateLimitEquivalent((String) map.get(ApplicationConstants.LOGIN_USERCODE), 
				(String) map.get(ApplicationConstants.LOGIN_CORP_ID), (String) map.get(ApplicationConstants.TRANS_SERVICE_CODE), 
				(String) map.get(ApplicationConstants.ACCOUNT_GRP_DTL_ID), 
				(BigDecimal) map.get(ApplicationConstants.TRANS_AMOUNT), 
				(String) map.get(ApplicationConstants.TRANS_CURRENCY), 
	...
	public CorporateUserPendingTaskVO approve(CorporateUserPendingTaskVO vo) throws ApplicationException, BusinessException {
		...
		String isCheckCOT = "";
		if(vo.getIsCheckCOT()==null) {
			isCheckCOT = "Y";
		}else {
			isCheckCOT = vo.getIsCheckCOT();
		}
		
		if(isCheckCOT.equals("Y")) {
	...
	public Map<String, Object> searchBeneficiary(Map<String, Object> map) throws ApplicationException, BusinessException {
		return beneficiaryListDomesticService.searchBeneficiary((String)map.get(ApplicationConstants.LOGIN_CORP_ID), 
				(String)map.get(ApplicationConstants.LOGIN_USERCODE));
	}
	...
	public Map<String, Object> cancelTransactionWF(Map<String, Object> map) throws ApplicationException, BusinessException {
		domesticTransferService.cancelTransactionWF(map);
	...
	public Map<String, Object> searchOnlineBeneficiary(Map<String, Object> map) throws ApplicationException, BusinessException {
		return beneficiaryListDomesticService.searchOnlineBeneficiary((String)map.get(ApplicationConstants.LOGIN_CORP_ID), (String)map.get(ApplicationConstants.LOGIN_USERCODE));
	}
	...
	@Input({ 
		...
		@Variable(name = "exchangeRate", options = { 
			ApplicationConstants.RATE_COUNTER, 
			ApplicationConstants.RATE_SPECIAL
		}, defaultValue = ApplicationConstants.RATE_COUNTER),
		@Variable(name = "instructionMode", options = { 
				ApplicationConstants.SI_IMMEDIATE, 
				ApplicationConstants.SI_FUTURE_DATE, 
				ApplicationConstants.SI_RECURRING 
	...
	public Map<String, Object> checkRate(Map<String, Object> map) throws ApplicationException, BusinessException {
		...
		if (String.valueOf(map.get("exchangeRate")).equals(ApplicationConstants.RATE_COUNTER)) {
			return transactionValidationService.validateCounterRate((String) map.get("sourceAccountCurrency"), (String) map.get(ApplicationConstants.TRANS_CURRENCY),(BigDecimal) map.get(ApplicationConstants.TRANS_AMOUNT));
		} else {
			...
			BigDecimal trxAmount = (BigDecimal) map.get(ApplicationConstants.TRANS_AMOUNT);
	...
	public Map<String, Object> validateCOT(Map<String, Object> map) throws ApplicationException, BusinessException {
		...
		return domesticTransferService.validateCOT(map);				
	}
	...
	public Map<String, Object> updatecheckCOTFlag(Map<String, Object> map) throws ApplicationException, BusinessException {
		...
		return domesticTransferService.updatecheckCOTFlag(map);				
	}
	
	@Override
	public Map<String, Object> updatecheckCOTFlagList(Map<String, Object> map) throws ApplicationException, BusinessException {
		
		return domesticTransferService.updatecheckCOTFlagList(map);				
	}

	@Override
	public void saveTransactionHoliday(Date holidayDate) throws ApplicationException, BusinessException {
		// TODO Auto-generated method stub
		System.out.println("Transaction Holiday Date  =  " + holidayDate);
		domesticTransferService.saveTransactionHoliday(holidayDate);
	}
}