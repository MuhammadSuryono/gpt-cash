...
public class PendingUploadBeneficiaryRepositoryImpl extends CashRepositoryImpl<PendingUploadBeneficiaryModel> implements PendingUploadBeneficiaryCustomRepository {
	...
	@Override
	public Page<PendingUploadBeneficiaryModel> searchPendingUpload(Map<String,Object> map, Pageable pageInfo) throws Exception {
		CriteriaBuilder builder = em.getCriteriaBuilder();
		CriteriaQuery<PendingUploadBeneficiaryModel> query = builder.createQuery(PendingUploadBeneficiaryModel.class);

		Root<PendingUploadBeneficiaryModel> root = query.from(PendingUploadBeneficiaryModel.class);
