package com.gpt.product.gpcash.corporate.transaction.domestic.controller;
...
@RestController
public class DomesticTransferController extends CorporateUserBaseController {

	protected static final String menuCode = "MNU_GPCASH_F_FUND_DOMESTIC";
	...
	public DeferredResult<Map<String, Object>> genericHandler(HttpServletRequest request, @PathVariable String method, @RequestBody Map<String, Object> param) {
		return invoke("DomesticTransferSC", method, param);
	}
	...
	public DeferredResult<Map<String, Object>> confirm(HttpServletRequest request,
		...
		return invoke("DomesticTransferSC", "confirm", (DeferredResult<Map<String, Object>> deferredResult, Map<String, Object> map) -> {
	...
	public DeferredResult<Map<String, Object>> approve(HttpServletRequest request,
		...
		return invoke("DomesticTransferSC", "submit", param);
	}
	...
	public DeferredResult<Map<String, Object>> downloadPeriodicTransaction(HttpServletRequest request, HttpServletResponse response, @RequestBody Map<String, Object> param) {
		return invoke("DomesticTransferSC", "downloadTransactionStatus", 
