...
@Validate
@Service
public class BillPaymentSCImpl implements BillPaymentSC {
	...
	@Input({
		...
		@Variable(name = ApplicationConstants.MIN_PAYMENT, type = BigDecimal.class, required = false),
	...
	public Map<String, Object> submit(Map<String, Object> map) throws ApplicationException, BusinessException {
		...
		if (map.get(ApplicationConstants.MIN_PAYMENT) != null) {		
			transactionValidationService.validateMinimumPayment((BigDecimal) map.get(ApplicationConstants.TRANS_AMOUNT), 
					(BigDecimal) map.get(ApplicationConstants.MIN_PAYMENT));
		}
	...
	public Map<String, Object> confirm(Map<String, Object> map) throws ApplicationException, BusinessException {
		...
		return billPaymentService.confirm(map);
	}
	...
	public Map<String, Object> searchPayee(Map<String, Object> map) throws ApplicationException, BusinessException {
		return payeeService.searchPayee((String)map.get(ApplicationConstants.LOGIN_CORP_ID), 
				(String)map.get(ApplicationConstants.LOGIN_USERCODE));
	}
	...
	public Map<String, Object> cancelTransactionWF(Map<String, Object> map) throws ApplicationException, BusinessException {
		billPaymentService.cancelTransactionWF(map);
