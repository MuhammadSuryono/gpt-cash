...
@Validate
@Service
public class ChargingReportSCImpl implements ChargingReportSC {

	@Autowired
	private ChargingReportService chargingReportService;
	...
	public Map<String, Object> downloadReport(Map<String, Object> map) throws ApplicationException {
		return chargingReportService.downloadReport(map, (String) map.get(ApplicationConstants.LOGIN_USERID));
	}
	...
	public void doGenerateReport(Map<String, Object> map) throws ApplicationException, BusinessException {
		chargingReportService.doGenerateReport(map, (String) map.get(ApplicationConstants.LOGIN_USERID));
	}
	...
	public Map<String, Object> searchMenu(Map<String, Object> map) throws ApplicationException, BusinessException {
		return chargingReportService.searchMenu();
	}
}
