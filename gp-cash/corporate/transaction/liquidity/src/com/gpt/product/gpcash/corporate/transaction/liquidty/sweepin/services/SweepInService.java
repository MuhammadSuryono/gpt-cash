...
@AutoDiscoveryImpl
public interface SweepInService extends CorporateUserWorkflowService {
	...
	void executeBatchTransaction(SweepInModel sweepIn);
	...
	void executeSweepBack(SweepInModel sweepIn);
