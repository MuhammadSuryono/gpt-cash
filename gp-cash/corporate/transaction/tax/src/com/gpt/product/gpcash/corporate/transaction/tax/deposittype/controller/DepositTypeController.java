package com.gpt.product.gpcash.corporate.transaction.tax.deposittype.controller;
...
@RestController
public class DepositTypeController extends BankBaseController {
	protected static final String menuCode = "MNU_GPCASH_TAX_DEPOSIT_TYP";
	...
	public DeferredResult<Map<String, Object>> genericHandler(HttpServletRequest request, @PathVariable String method, @RequestBody Map<String, Object> param) {
		return invoke("DepositTypeSC", method, param);
	}
}
