...
@Validate
@Service
public class DepositTypeSCImpl implements DepositTypeSC {
	...
	public Map<String, Object> search(Map<String, Object> map) throws ApplicationException, BusinessException {
		return depositTypeService.search(map);
	}
	...
	public Map<String, Object> submitDelete(Map<String, Object> map) throws ApplicationException, BusinessException {
		return this.depositTypeService.submit(map);
	}

	@Override
	public Map<String, Object> searchTaxTypeForDroplist(Map<String, Object> map) throws ApplicationException, BusinessException {
	...
	@Input({
		...
		@Variable(name = "taxDepositCode"),
		@Variable(name = "dscp"),
		@Variable(name = "taxTypeCode"),
		@Variable(name = ApplicationConstants.LOGIN_USERID, format = Format.UPPER_CASE),
		@Variable(name = ApplicationConstants.WF_ACTION, options = { 
	...
	public PendingTaskVO approve(PendingTaskVO vo) throws ApplicationException, BusinessException {
		return this.depositTypeService.approve(vo);
	}

	@Override
	public PendingTaskVO reject(PendingTaskVO vo) throws ApplicationException, BusinessException {
		return this.depositTypeService.reject(vo);
	}
