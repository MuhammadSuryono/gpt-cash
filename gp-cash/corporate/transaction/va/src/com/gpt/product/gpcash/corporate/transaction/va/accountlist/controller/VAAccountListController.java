package com.gpt.product.gpcash.corporate.transaction.va.accountlist.controller;
...
@RestController
public class VAAccountListController extends CorporateUserBaseController{
	protected static final String menuCode = "MNU_GPCASH_F_CORP_VA_LIST";
	...
	public DeferredResult<Map<String, Object>> genericHandler(HttpServletRequest request, @PathVariable String method, @RequestBody Map<String, Object> param) {
		return invoke("VAAccountListSC", method, param);
	}	
}
