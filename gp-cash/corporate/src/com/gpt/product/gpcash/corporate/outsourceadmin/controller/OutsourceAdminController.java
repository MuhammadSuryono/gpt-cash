package com.gpt.product.gpcash.corporate.outsourceadmin.controller;
...
@RestController
public class OutsourceAdminController extends BankBaseController {
	
	protected static final String menuCode = "MNU_GPCASH_OUTSOURCE_ADMIN";
	...
	public DeferredResult<Map<String, Object>> genericHandler(HttpServletRequest request, @PathVariable String method, @RequestBody Map<String, Object> param) {
		return invoke("OutsourceAdminSC", method, param);
	}
