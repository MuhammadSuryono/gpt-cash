...
public class SpecialRateRepositoryImpl extends CashRepositoryImpl<SpecialRateModel> {
	...
	@Override
	public Page<SpecialRateModel> search(Map<String, Object> paramMap, Pageable pageInfo) throws Exception {
		CriteriaBuilder builder = em.getCriteriaBuilder();
		CriteriaQuery<SpecialRateModel> query = builder.createQuery(SpecialRateModel.class);
		
		Root<SpecialRateModel> root = query.from(SpecialRateModel.class);
