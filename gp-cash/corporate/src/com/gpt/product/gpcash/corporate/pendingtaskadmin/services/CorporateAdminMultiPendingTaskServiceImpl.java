...
@Service
public class CorporateAdminMultiPendingTaskServiceImpl implements CorporateAdminMultiPendingTaskService{
	private static final Logger logger = LoggerFactory.getLogger(CorporateAdminMultiPendingTaskServiceImpl.class);
