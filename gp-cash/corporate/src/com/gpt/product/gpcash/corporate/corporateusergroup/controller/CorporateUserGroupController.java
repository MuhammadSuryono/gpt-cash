package com.gpt.product.gpcash.corporate.corporateusergroup.controller;
...
@RestController
public class CorporateUserGroupController extends CorporateAdminBaseController {
	
	protected static final String menuCode = "MNU_GPCASH_F_USER_GROUP";
	...
	public DeferredResult<Map<String, Object>> genericHandler(HttpServletRequest request, @PathVariable String method, @RequestBody Map<String, Object> param) {
		return invoke("CorporateUserGroupSC", method, param);
	}
}
