...
public class SpecialRateServiceImpl implements SpecialRateService {
	...
	public Map<String, Object> search(Map<String, Object> map) throws ApplicationException, BusinessException {
		...
		try {
			Page<SpecialRateModel> result = specialRateRepo.search(map, PagingUtils.createPageRequest(map));
	...
	private List<Map<String, Object>> setModelToMap(List<SpecialRateModel> list, boolean isGetDetail) throws Exception {
		List<Map<String, Object>> resultList = new ArrayList<>();

		for (SpecialRateModel model : list) {
			resultList.add(setModelToMap(model, isGetDetail));
		}
		return resultList;
	}
	
	private Map<String, Object> setModelToMap(SpecialRateModel model, boolean isGetDetail) throws Exception {
	...
	public Map<String, Object> submit(Map<String, Object> map) throws ApplicationException, BusinessException {
		...
		try {
			...
			if (map.get(ApplicationConstants.WF_ACTION).equals(ApplicationConstants.WF_ACTION_CREATE)) {
				...
				SpecialRateModel specialRateOld = getExistingModel((String) map.get("refNoSpecialRate"), true);
	...
	private SpecialRateModel getExistingModel(String refNoSpecialRate, boolean isThrowError) throws BusinessException, Exception {
	...
	public SpecialRateModel updateStatus(String refNoSpecialRate, String status, String updatedBy) throws BusinessException, Exception {
		SpecialRateModel specialRate = getExistingModel(refNoSpecialRate, true);
	...
	private PendingTaskVO setPendingTaskVO(Map<String, Object> map) {
		...
		vo.setService("SpecialRateSC");

		return vo;
	}

	private SpecialRateModel setMapToModel(Map<String, Object> map) throws ParseException {
		SpecialRateModel specialRate = new SpecialRateModel();
	...
	private void checkUniqueRecord(PendingTaskVO vo) throws Exception {
		...
		List<SpecialRateModel> list = specialRateRepo.search(mapInput, null).getContent();
	...
	public PendingTaskVO approve(PendingTaskVO vo) throws ApplicationException, BusinessException {
		try {
			...
			if (ApplicationConstants.WF_ACTION_CREATE.equals(vo.getAction())) {
				SpecialRateModel specialRate = setMapToModel(map);
				...
				SpecialRateModel specialRateNew = setMapToModel(map);

				SpecialRateModel specialRateExisting = getExistingModel(specialRateNew.getRefNoSpecialRate(), true);
				...
				SpecialRateModel specialRate = getExistingModel((String) map.get("refNoSpecialRate"), true);
