...
@AutoDiscoveryImpl
public interface TransactionStatusAdminService {
	...
	Map<String, Object> detailTransactionStatusForNonFinancial(Map<String, Object> map) throws ApplicationException, BusinessException;

	Map<String, Object> searchNonFinancialActivityForBank(Map<String, Object> map) throws ApplicationException, BusinessException;
