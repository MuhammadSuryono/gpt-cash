...
public class CorporateUserPendingTaskVO {
	protected String id;
	...
	protected String actionByLevelName;
	protected String actionByLevelAlias;
	...
	public String getActionByLevelName() {
		return actionByLevelName;
	}
	
	public void setActionByLevelName(String actionByLevelName) {
		this.actionByLevelName = actionByLevelName;
	}
	
	public String getActionByLevelAlias() {
		return actionByLevelAlias;
	}
	
	public void setActionByLevelAlias(String actionByLevelAlias) {
		this.actionByLevelAlias = actionByLevelAlias;
	}
