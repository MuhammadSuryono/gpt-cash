...
public class CorporateUserManagerForBankServiceImpl implements CorporateUserManagerForBankService {
	...
	public Map<String, Object> findByStillLogin(Map<String, Object> map)
		...
		try {
			...
			String corporateId = Helper.getSearchWildcardValue((String) map.get(ApplicationConstants.CORP_ID));

			Page<Object[]> result = corporateUserRepo.findStillLoginUsers(corporateId, userId, stillLoginFlag,
