package com.gpt.product.gpcash.corporate.transactionupdate.controller;
...
@RestController
public class TransactionUpdateController extends BankBaseController {
	
	protected static final String menuCode = "MNU_GPCASH_BO_TRX_UPDATE";
	...
	public DeferredResult<Map<String, Object>> genericHandler(HttpServletRequest request, @PathVariable String method, @RequestBody Map<String, Object> param) {
		return invoke("TransactionUpdateSC", method, param);
	}
