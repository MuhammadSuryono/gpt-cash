package com.gpt.product.gpcash.corporate.corporatelimit.controller;
...
@RestController
public class CorporateLimitController extends BankBaseController {
	
	protected static final String menuCode = "MNU_GPCASH_CORP_LMT_PC_DTL";
	...
	public DeferredResult<Map<String, Object>> genericHandler(@PathVariable String method, @RequestBody Map<String, Object> param) {
		...
		return invoke("CorporateLimitSC", method, param);
	}
}
