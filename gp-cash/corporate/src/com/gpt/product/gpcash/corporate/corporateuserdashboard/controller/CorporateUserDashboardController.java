package com.gpt.product.gpcash.corporate.corporateuserdashboard.controller;
...
@RestController
public class CorporateUserDashboardController extends CorporateUserBaseController {

	protected static final String menuCode = "MNU_GPCASH_F_USER_DASHBOARD";
	...
	public DeferredResult<Map<String, Object>> genericHandler(@PathVariable String method, @RequestBody Map<String, Object> param) {
		return invoke("CorporateUserDashboardSC", method, param);
	}
	
	@RequestMapping(baseCorpUserUrl + "/" + menuCode + "/uploadAvatar")
