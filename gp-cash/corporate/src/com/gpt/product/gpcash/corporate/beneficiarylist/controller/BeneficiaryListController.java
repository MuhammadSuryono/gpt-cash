package com.gpt.product.gpcash.corporate.beneficiarylist.controller;
...
@RestController
public class BeneficiaryListController extends CorporateUserBaseController {

	protected static final String menuCode = "MNU_GPCASH_F_FUND_BENEFICIARY";
	...
	public DeferredResult<Map<String, Object>> genericHandler(HttpServletRequest request, @PathVariable String method, @RequestBody Map<String, Object> param) {
		return invoke("BeneficiaryListSC", method, param);
	}
