package com.gpt.product.gpcash.corporate.transactionstatusforbank.controller;
...
@RestController
public class TransactionStatusForBankController extends BankBaseController {
	
	protected static final String menuCode = "MNU_GPCASH_BO_RPT_TRX_STS";
	...
	public DeferredResult<Map<String, Object>> genericHandler(HttpServletRequest request, @PathVariable String method, @RequestBody Map<String, Object> param) {
		return invoke("TransactionStatusForBankSC", method, param);
	}
